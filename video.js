var ScrollyVideo = function() {
    ...
    function(t, e) {
        var i = "function"
          ...
          , V = function(t, s) {
            for (var r, n, o, h, d, l, p = 0; p < s.length && !d; ) {
                var f = s[p]
                  , u = s[p + 1];
                for (r = n = 0; r < f.length && !d; )
                    if (d = f[r++].exec(t))
                        for (o = 0; o < u.length; o++)
                            l = d[++n],
                            typeof (h = u[o]) === a && h.length > 0 ? 2 === h.length ? typeof h[1] == i ? this[h[0]] = h[1].call(this, l) : this[h[0]] = h[1] : 3 === h.length ? typeof h[1] !== i || h[1].exec && h[1].test ? this[h[0]] = l ? l.replace(h[1], h[2]) : e : this[h[0]] = l ? h[1].call(this, l, h[2]) : e : 4 === h.length && (this[h[0]] = l ? h[3].call(this, l.replace(h[1], h[2])) : e) : this[h] = l || e;
                p += 2
            }
        }
          , Y = function(t, i) {
            for (var s in i)
                if (typeof i[s] === a && i[s].length > 0) {
          ...
          , W = function(i, s) {
            ...
            i = e),
            !(this instanceof W))
                return new W(i,s).getResult();
            var r = i || (typeof t !== n && t.navigator && t.navigator.userAgent ? t.navigator.userAgent : "")
              , c = s ? function(t, e) {
                var i = {};
                for (var s in t)
            ...
            return this.getBrowser = function() {
                ...
                return i[d] = e,
                i[f] = e,
                V.call(i, r, c.browser),
                i.major = typeof (t = i.version) === o ? t.replace(/[^\d\.]/g, "").split(".")[0] : e,
                i
            }
            ,
        ...
        W.ENGINE = W.OS = M([d, f]),
        s.exports && (r = s.exports = W),
        r.UAParser = W;
        var K = typeof t !== n && (t.jQuery || t.Zepto);
        if (K && !K.ua) {
            var X = new W;
            K.ua = X.getResult(),
            K.ua.get = function() {
    ...
    }("object" == typeof window ? window : i.exports)),
    i.exports), o = t(a), h = {};
    var d = (n || (n = 1,
    function(t) {
        ...
        u.prototype.parse = function() {
            ...
            if (!this.restoreParsePosition || this.restoreParsePosition())
                for (; ; ) {
                    ...
                    (t = l.parseOneBox(this.stream, !1)).code === l.ERR_NOT_ENOUGH_DATA) {
        ...
        u.prototype.addTrack = function(t) {
            ...
            if (void 0 !== l[e.type + "SampleEntry"]) {
                ...
                case "Subtitle":
                    r.add("sthd"),
                    "stpp" === e.type && a.set("namespace", e.namespace || "nonamespace").set("schema_location", e.schema_location || "").set("auxiliary_mime_types", e.auxiliary_mime_types || "");
                    break;
                default:
                    r.add("nmhd")
                }
        ...
        u.setSampleGroupProperties = function(t, e, i, s) {
            ...
            s) {
                ...
                0 !== e.sample_groups[r].group_description_index && (a = s[r].fragment_description ? s[r].fragment_description : s[r].description,
        ...
        u.prototype.buildTrakSampleLists = function(t) {
            ...
            void 0 !== r) {
                for (e = 0; e < r.sample_sizes.length; e++) {
                    ...
                    B.chunk_index = m,
                    g = 0,
                    m <= _ || (_ = 1 + ++c < s.first_chunk.length ? s.first_chunk[c + 1] - 1 : 1 / 0),
                    B.chunk_run_index = c,
                    y += s.samples_per_chunk[c]),
                    ...
                    w < 0 && (w = 0),
                    w += a.sample_counts[S]),
                    B.cts = t.samples[e].dts + a.sample_offsets[S]) : B.cts = B.dts,
                    o ? (e == o.sample_numbers[U] - 1 ? (B.is_sync = !0,
                    U++) : (B.is_sync = !1,
                        ...
                        t = 0; t < d.trafs.length; t++) {
                            ...
                            if (p.subs) {
                                ...
                                for (e = 0; e < p.subs.entries.length; e++)
                                    ...
                                    (m = f.samples[S - 1]).subsamples = p.subs.entries[e].subsamples
                            }
                        }
        }
        ,
    ...
    const p = (t, e, {VideoDecoder: i, EncodedVideoChunk: s, debug: r}) => new Promise(( (n, a) => {
        r && console.info("Decoding video from", t);
        try {
            const o = d.createFile();
            let h;
            const p = new i({
                output: t => {
                    createImageBitmap(t, {
            ...
            o.onReady = t => {
                if (t && t.videoTracks && t.videoTracks[0]) {
                    ...
                    a(new Error("URL provided is not a valid mp4 video file."))
            }
            ,
            o.onSamples = (t, e, i) => {
    ...
    ;
    return class {
        constructor({src: t, scrollyVideoContainer: e, cover: i=!0, sticky: s=!0, full: r=!0, trackScroll: n=!0, lockScroll: a=!0, transitionSpeed: h=8, frameThreshold: d=.1, useWebCodecs: l=!0, onReady: p= () => {}
        , onChange: u= () => {}
        , debug: c=!1}) {
            ...
            r && (this.container.style.width = "100%",
            this.container.style.height = "100vh",
            this.container.style.overflow = "hidden"),
            i && this.setCoverStyle(this.video);
            const m = (new o).getEngine();
            ...
            this.updateScrollPercentage = t => {
                ...
                null == this.targetScrollPosition ? (this.setTargetTimePercent(i, {
                    jump: t
                }),
                this.onChange(i)) : f(this.targetScrollPosition) ? this.targetScrollPosition = null : a && null != this.targetScrollPosition && _()
            }
            ,
        ...
        setVideoPercentage(t, e={}) {
            this.videoPercentage !== t && (this.transitioningRaf && window.cancelAnimationFrame(this.transitioningRaf),
            ...
            if (this.useWebCodecs)
                if (this.src) {
                    try {
                        ...
                        this.debug && console.error("Error encountered while decoding video", t),
                        this.frames = [],
                        this.video.load()
                    }
                    var t, e, i;
                    if (0 === this.frames.length)
                        return this.debug && console.error("No frames were received from webCodecs"),
                        void this.onReady();
        ...
        transitionToTargetTime({jump: t, transitionSpeed: e=this.transitionSpeed, easing: i=null}) {
            ...
            const s = this.targetTime - this.currentTime
              ...
              , o = ({startCurrentTime: s, startTimestamp: h, timestamp: d}) => {
                ...
                if (isNaN(this.targetTime) || Math.abs(this.targetTime - this.currentTime) < this.frameThreshold || p)
                    return this.video.pause(),
                    void (this.transitioningRaf && (cancelAnimationFrame(this.transitioningRaf),
                ...
                if (this.canvas)
                    t ? this.currentTime = this.targetTime : u ? this.currentTime = c : this.currentTime += f / (256 / e),
                    this.paintCanvasFrame(Math.floor(this.currentTime * this.frameRate));
        ...
        setTargetTimePercent(t, e={}) {
            ...
            !e.jump && Math.abs(this.currentTime - this.targetTime) < this.frameThreshold || (this.canvas || this.video.paused || this.video.play(),
            this.transitionToTargetTime(e))
        }
        setScrollPercent(t) {
            if (!this.trackScroll)
                return void console.warn("`setScrollPercent` requires enabled `trackScroll`");
            const e = this.container.parentNode
              , {top: i, height: s} = e.getBoundingClientRect()
              , r = i + window.pageYOffset + (s - window.innerHeight) * t;
            f(r) ? this.targetScrollPosition = null : (window.scrollTo({
                top: r,
                behavior: "smooth"
            }),
